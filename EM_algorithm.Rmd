...
crossvalidation.EM = function(X, K, k_fold, max_it=1000, initialization){
  "
  ...
  vector_groups = ceiling((1:n)/(n/fold_number))
...
# use the AIC, BIC and likelihood from the cross-validation fucntion to determine the number of clusters (which I guess would be 3)
```
