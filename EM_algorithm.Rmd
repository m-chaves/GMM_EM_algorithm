...
To start, we will work only with 2 variables: Fixed acidity and Alcohol.  We can see in the following graph that many times the 3 clusters overlap. 
```{r data loading}
data(wine)
...
```{r number of cluster selection for higher dimensions case}
