...
max_x= max(sapply(mu_list, function(x){dim(x)[1]}))

p1 <- plot_hist_mu(data_mu, K)
p1_1<- p1[[1]] + ylab(colnames(X)[1]) + xlab('Iteration') + xlim(0, max_x)
p1_2<- p1[[2]] + ylab(colnames(X)[2]) + xlab('Iteration') + xlim(0, max_x)
if (plt_n%%2 == 1 & K==2){
